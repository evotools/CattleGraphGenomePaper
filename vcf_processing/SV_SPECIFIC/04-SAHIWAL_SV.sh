...
if [ ! -e INTERSECT_BN_ASM/Sahiwal ]; then mkdir INTERSECT_BN_ASM/Sahiwal ; fi
bedtools intersect -header -a Sahiwal_final/Sahiwal.consensus.VEP.QUAL30.20DP90.AC5.SV500.vcf.gz -b INTERSECT_BN_ASM/OMregions.bed | vcf-sort | vcfuniq | bgzip -c > INTERSECT_BN_ASM/Sahiwal/Sahiwal.consensus.VEP.QUAL30.20DP90.AC5.SV500.intersectOM.vcf.gz
bedtools subtract -header -a Sahiwal_final/Sahiwal.consensus.VEP.QUAL30.20DP90.AC5.SV500.vcf.gz -b INTERSECT_BN_ASM/OMregions.bed | vcf-sort | vcfuniq |bgzip -c > INTERSECT_BN_ASM/Sahiwal/Sahiwal.consensus.VEP.QUAL30.20DP90.AC5.SV500.notInOM.vcf.gz
