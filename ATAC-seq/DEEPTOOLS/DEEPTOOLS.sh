...
plotHeatmap -m ./DEEPTOOLS/MULTI/matrix.genes.multi.mat.gz --averageTypeSummaryPlot median -out ./DEEPTOOLS/MULTI/multi_GenesHeatmap.png
...
plotHeatmap -m ./DEEPTOOLS/MULTI/matrix.augustus.multi.mat.gz --averageTypeSummaryPlot median -out ./DEEPTOOLS/MULTI/multi_augustusGenesHeatmap.png
...
plotHeatmap -m ./DEEPTOOLS/MULTI/matrix.genes.multi.refpoint.mat.gz --averageTypeSummaryPlot median -out ./DEEPTOOLS/MULTI/multi_GenesHeatmap_refpoint.png
...
plotHeatmap -m ./DEEPTOOLS/MULTI/matrix.augustus.multi.refpoint.mat.gz --averageTypeSummaryPlot median -out ./DEEPTOOLS/MULTI/multi_augustusGenesHeatmap_refpoint.png
